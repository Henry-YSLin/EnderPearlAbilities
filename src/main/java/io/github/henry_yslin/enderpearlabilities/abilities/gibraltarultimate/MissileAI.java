...
public class MissileAI extends AbilityRunnable {
    ...
    public void tick() {
        ...
        if (lastLocation != null && tnt.getLocation().equals(lastLocation)) {
            stationaryTicks++;
    ...
    protected void end() {
        ...
        for (Entity entity : tnt.getWorld().getNearbyEntities(center, EXPLOSION_RADIUS, EXPLOSION_RADIUS, EXPLOSION_RADIUS, entity -> entity instanceof LivingEntity)) {
            ...
            if (result == null) {
                ...
                livingEntity.addPotionEffect(PotionEffectType.SLOW.createEffect(40, 3));
                livingEntity.addPotionEffect(PotionEffectType.BLINDNESS.createEffect(20, 0));
            }
        }
        tnt.remove();
    }
