...
public class WorldShaperAbilityInfo extends MultipleChargeAbilityWithDurationInfo {
    ...
    public String getUsage() {
        return "Right click to fire. The tool held in main hand will be used to mine a 3x3 area where the projectile lands. Blocks inside this blast area will not be mined if the tool in main hand cannot produce block drops from those blocks. Tool durability will not completely deplete while using this ability. There is a high chance for the ender pearl to drop as item after the blast.";
    }
